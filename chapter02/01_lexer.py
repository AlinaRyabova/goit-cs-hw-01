...
class TokenType:
    ...
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL"       # Новий тип для операції множення
    DIV = "DIV"       # Новий тип для операції ділення
    LPAREN = "LPAREN" # Новий тип для лівої дужки
    RPAREN = "RPAREN" # Новий тип для правої дужки
...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            if self.current_char == "*":  # Розпізнаємо символ множення
                self.advance()
            return Token(TokenType.MUL, "*")

        if self.current_char == "/":  # Розпізнаємо символ ділення
            self.advance()
            return Token(TokenType.DIV, "/")

        if self.current_char == "(":  # Розпізнаємо відкриваючу дужку
            self.advance()
            return Token(TokenType.LPAREN, "(")

        if self.current_char == ")":  # Розпізнаємо закриваючу дужку
            self.advance()
